const app = () => {
  ...
  toogleIcons.forEach(icon =>{
      icon.addEventListener("click", (e) => {tooglePassword(e, passwordInputs, icon)});
  })
...
const tooglePassword = (e, inputs, toogleBtn) => {
  inputs.forEach(input =>{
    ...
    e.target.previousElementSibling.setAttribute("type", (type === "password" ? "text" : "password"));
